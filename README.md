...
<h3>상세 기획은 [(./ProjectProposal.md)](https://github.com/sHiARin/EMSW/blob/main/ProjectProposal.md) 참고하시오.</h3>

<hr>
<h2>프로젝트 작업 개요</h2>
TreeView에서 문서 탭을 만들고, 이 문서탭을 클릭하여 작업창을 열어서 이 작업창을 만들 수 있게 만듬(진행중) // 작업 내용 링크
